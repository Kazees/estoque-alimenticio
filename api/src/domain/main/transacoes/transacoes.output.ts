...
export class TransacoesOutput {
    ...
    constructor(transacao: TransacoesEntity) {
        ...
        this.lote = { numero_lote: transacao.transacoesProduto[0].lote.numero_lote, preco_custo: Number(transacao.transacoesProduto[0].lote.preco_custo), preco_venda: Number(transacao.transacoesProduto[0].lote.preco_venda) };
